...
exports.OutreachDefRepository = void 0;
const COLLECTION_NAME = 'outreachDefs';
class OutreachDefRepository {
    constructor(db) {
        this.db = db;
    }
    ...
    getListForProgramAsync(clientId, programId) {
        return __awaiter(this, void 0, void 0, function* () {
...
exports.OutreachDefRepository = OutreachDefRepository;
