...
exports.ProgramDefRepository = void 0;
const COLLECTION_NAME = 'programDefs';
class ProgramDefRepository {
    constructor(db) {
        this.db = db;
    }
    ...
    getListForSolutionAsync(clientId, solutionId) {
        return __awaiter(this, void 0, void 0, function* () {
            const entityCollectionRef = this.db.collection(COLLECTION_NAME).where('solutionId', '==', solutionId);
            const entityRefCollection = yield entityCollectionRef.get();
            const entityList = entityRefCollection.docs.map((entityDoc) => {
                const entity = entityDoc.data();
                return entity;
...
exports.ProgramDefRepository = ProgramDefRepository;
